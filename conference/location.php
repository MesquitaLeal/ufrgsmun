<div id="location">
    <div class="subpage-title">
        <h6>Home <i class="fa fa-angle-double-right"></i> Conference Info <i class="fa fa-angle-double-right"></i> Location</h6>
    </div>
    <div class="row blue content">
        ...
        <div class="address col-md-7">
            ...
            <address>
                <i class="fa fa-map-marker"></i> Alberto Bins, 514 -  Porto Alegre/RS<br/><i class="fa fa-phone"></i> Phone: +55 51 3220.7000  / Fax: +55 51 3220.7001 / Toll-Free: 0800.7075292
            </address>
        </div>
    </div>
